...
> **Developer notes on branch `remove-copy-to-slave`**
>
> Delete this note after completing work on branch `remove-copy-to-slave` and
> before merging to `master`.
>
> While working at Wave Computing, I began the process of removing the dependency
> on the Copy-To-Slave plugin, which was deprecated due to security concerns. Due
> to changing priorities at Wave, I was unable to complete it. So I created
> this branch containing my intermediate results in the hope that they might help
...
In August 2018, SGE Cloud Plugin version 1.23 and below was declared insecure
because it depended on the insecure Copy-To-Slave plugin. This dependency was
removed in SGE Cloud Plugin version 2.0, so the SGE Cloud Plugin is once again
secure.
